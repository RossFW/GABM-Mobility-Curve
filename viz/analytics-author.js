...
function renderLogOddsWalkthrough() {
  ...
  h += '<tr><td>GPT-4o</td><td colspan="2" style="text-align:center"><em>(see Fig 29)</em></td><td>&minus;9.2</td></tr>';
  h += '<tr><td>GPT-5.2 (low)</td><td colspan="2" style="text-align:center"><em>(see Fig 29)</em></td><td>&minus;0.6</td></tr>';
  h += '</tbody></table>';
